...
void MainMenu::init(sf::Vector2f windowSize) {
    ...
    m_playGameText.setPosition(m_windowSize.x / 2, m_windowSize.y * .45f);
    ...
    m_optionsText.setPosition(m_windowSize.x / 2, m_windowSize.y * .55f);
    ...
    m_exitText.setPosition(m_windowSize.x / 2, m_windowSize.y * .65f);
